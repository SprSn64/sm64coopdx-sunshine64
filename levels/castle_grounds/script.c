...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(E_MODEL_FLUDDPICKUP, -185, 166, 3034, 0, -180, 0, 0x00000000, id_bhvfluddPickup),
		OBJECT(E_MODEL_FLUDDPICKUP, -785, 166, 3034, 0, -180, 0, 0x00000000, id_bhvfluddPickup),
		OBJECT(E_MODEL_GOOBLE, -361, 166, 4126, 0, -180, 0, 0x00000000, id_bhvGoomba),
		OBJECT(E_MODEL_STROLLINSTU, 8552, 166, -7798, 0, -180, 0, 0x00000000, id_bhvGoomba),
